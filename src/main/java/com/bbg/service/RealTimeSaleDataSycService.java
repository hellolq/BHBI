...
import com.bbg.pojo.realTime.PCursor;
 ...
 */
@Service
public class RealTimeSaleDataSycService {
    ...
    public String getRclTime(){
        ...
        bhbiJdbcTemplate.query(sql, new RowCallbackHandler() {
    ...
    public void deleteData(String time){
        ...
        bhbiJdbcTemplate.execute(sql);
        bhbiJdbcTemplate.execute(sql2);
    }
    ...
    public Map<String, PCursor> getPCursor(String rq) {
        ...
        bhbiJdbcTemplate.setFetchSize(5000);
        bhbiJdbcTemplate.query(sql, new RowCallbackHandler() {
    ...
    public void exec_real_xsbf(String time) throws IOException {
        ...
        Iterator<Map.Entry<String, PCursor>> it = mpc.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<String, PCursor> entry = it.next();
        ...
        bhbiJdbcTemplate.batchUpdate(sql,new BatchPreparedStatementSetter() {
